...
@app.cell
def _(mo):
    mo.md(r"""## Смотрим, как число итераций зависит от начального приближения""")
    return
...
def _(mo):
    mo.md(r"""## Для визуализации процесса вычисления корня функции методом Ньютона на понадобится преобразовать историю процесса в массивы NumPy""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""## Визуализация процесса вычисления корней функции методом Ньютона""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""## Метод Ньютона с численным вычислением производной функции""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""## Статистическое моделирование поиска корня защумленной функции""")
    return
