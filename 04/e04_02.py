...
def _(mo):
    mo.md(r"""## Частотный анализ символов в литературных произведениях""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Конструируем словарь частот символов""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""## Кумуллятивное распредение""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Сортированные по возрастанию кодов  символы""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Зашифрование, расшифрование""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Пытаемся расшифровать текст методом грубой, предполагая, что он зашифрован цифром Цезаря, а где-то в тексте присутствует имя главного героя Йоссариан (иначе нам пришлось бы вручную просматривать каждый расшифрованный текст)""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""# Алгоритм Вернама (одноразовые блокноты)""")
    return
