...
@app.cell
def _(mo):
    mo.md(r"""## Раскладываем биты числа 241 на биты""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""## Устанавливаем или сбрасываем младший бит в байте""")
    return
...
def _(mo):
    mo.md(r"""## Читаем цитату к главе 4 из файловой системы""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Читаем изображение заставки""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Вставляем сообщение в изображение""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Формируем разностное изображение""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Извлекаем сообщение из массива""")
    return
