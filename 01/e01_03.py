...
def _(mo):
    mo.md(r"""
    Нарисуем графики функций $C(t)$ и $S(t)$
    """)
    return
...
def _(mo):
    mo.md(r"""
    Вычислим максимальную погрешность вычисления интегралов Френеля:
    """)
    return
...
def _(mo):
    mo.md(r"""
    Анимация окружности и переходного участка  при изменении радиуса поворотного круга
    """)
    return
...
def _(mo):
    mo.md(r"""
    Собираем кадры и сохраняем анимацию в файловой системе
    """)
    return
...
def _(mo):
    mo.md(r"""
    Анимация переходного участка и поворотного круга при изменении его радиуса
    """)
    return
