...
@app.cell
def _():
    mo.md(r"""### Унифицируем исходные фигуры""")
    return
...
@app.cell
def _():
    mo.md(r"""Делаем то же с другими фигурами""")
    return
...
@app.cell
def _():
    mo.md(r"""Делаем четыре маленьких фигурки из всех исходных фигур""")
    return
...
@app.cell
def _():
    mo.md(r"""### Компоновка фигуры с двумя маленькими фигурами""")
    return
...
@app.cell
def _():
    mo.md(r"""### Теперь можно сконстрировать квадратный предел из произвольной фигуры""")
    return
...
@app.cell
def _():
    mo.md(r"""### Никто не мешает нам изготовить квадратные пределы из других фигур""")
    return
...
@app.cell
def _():
    mo.md(r"""## Изготовим теперь большие рисунки квадратных пределов""")
    return
...
@app.cell
def _():
    mo.md(r"""## Изготовим теперь набор Квадратных пределов из всех порождающих фигур""")
    return
